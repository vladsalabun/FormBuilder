...
class FormBuilderErrors
{
    ...
    static $errors = [
        ...
        102 => 'Хибне значення обов\'язкового параметру selected_value. Доступні значання: строка, число, або null.',
        103 => 'Хибне значення додаткового параметру label. Доступні значання: строка, число, або null.',
        104 => 'Хибне значення додаткового параметру class. Доступні значання: строка або null.',
        105 => 'Хибне значення додаткового параметру required. Доступні значання: true або false.',
